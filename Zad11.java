...
public class Zad11 {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (ab == bc & bc == cd & cd == da & da == ab & ac == bd) {//"1) Существует ли? 2) какой четырехугольник? 3) какова площадь? 4) можно ли вписать в окружность?"//
    ...
    public static void printmas(double[][] array) {
